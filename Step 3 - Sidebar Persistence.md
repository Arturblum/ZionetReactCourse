...
- This hook is used inside the Provider (`CartProvider`) to persist:
  - cart sidebar open/closed (`cart-open`)
...
- Add to cart → refresh → cart should still contain the item(s).
